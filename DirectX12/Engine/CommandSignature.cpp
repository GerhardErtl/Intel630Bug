...
void CommandSignature::Finalize(ID3D12Device4* device, const RootSignature* RootSignature )
{
    if (m_Finalized)
        return;
    ...
    ASSERT_SUCCEEDED(device->CreateCommandSignature(&CommandSignatureDesc, pRootSig,

...
public:
    ...
    RootSignature(GraphicsCore& core, UINT NumRootParams = 0, UINT NumStaticSamplers = 0 ) : m_core(core), m_NumParameters(NumRootParams)
    {
    ...
    void Finalize(ID3D12Device4*& device, const std::wstring& name, D3D12_ROOT_SIGNATURE_FLAGS Flags = D3D12_ROOT_SIGNATURE_FLAG_NONE);

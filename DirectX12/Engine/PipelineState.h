...
public:
    ...
    PSO(GraphicsCore& core) : m_core(core), m_RootSignature(nullptr), m_PSO(nullptr) {}
...
public:
    ...
    void GetRenderTargetFormat(DXGI_FORMAT& RTVFormat, DXGI_FORMAT& DSVFormat, UINT& MsaaCount, UINT& MsaaQuality);
    bool UpdateMsaaCount(UINT MsaaCount);
    ...
    void Finalize(ID3D12Device4*& device);

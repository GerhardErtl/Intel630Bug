...
public:
    ...
    void Create(ID3D12Device* pDevice, D3D12_COMMAND_QUEUE_FLAGS commandQueueFlag = D3D12_COMMAND_QUEUE_FLAGS::D3D12_COMMAND_QUEUE_FLAG_NONE);
    void Shutdown();
...
public:
    CommandListManager(GraphicsCore& core);
    ~CommandListManager();

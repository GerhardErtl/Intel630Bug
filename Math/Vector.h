...
namespace Math
{
    ...
    public:
        ...
        __declspec(property (put = SetX, get = GetX)) Scalar x;
        __declspec(property (put = SetY, get = GetY)) Scalar y;
        __declspec(property (put = SetZ, get = GetZ)) Scalar z;
        __declspec(property (put = SetW, get = GetW)) Scalar w;
        ...
        INLINE float Length() {
            return DirectX::XMVector3Length(m_vec).m128_f32[0];
        }

        INLINE float Len2() {
            return DirectX::XMVector3Dot(m_vec, m_vec).m128_f32[0];
        }
	...
	public:
        ...
        INLINE IntVector2 operator- () const
        {
            return IntVector2(-this->x, -this->y);
        }

        INLINE IntVector2 operator+ (IntVector2 v2) const
        {
        ...
        INLINE IntVector2 operator* (int v) const
        {
            return IntVector2(this->x * v, this->y * v);
        }
        ...
        INLINE IntVector2& operator += (IntVector2 v)
        {
            *this = *this + v;
            return *this;
        }
    ...
    public:
        ...
        INLINE IntVector4 operator- () const
        {
            return IntVector4(-this->x, -this->y, -this->z, -this->w);
        }

        INLINE IntVector4 operator+ (IntVector4 v2) const
        {
            return IntVector4(this->x + v2.x, this->y + v2.y, this->z + v2.z, this->w +v2.w);
        }
        ...
        INLINE IntVector4 operator* (int v) const
        {
            return IntVector4(this->x * v, this->y * v, this->z * v, this->w * v);
        }
        ...
        INLINE IntVector4& operator += (IntVector4 v)
        {
            *this = *this + v;
            return *this;
        }
    ...
    public:
    	...
    	INLINE float& operator[](int v)
    	{
            return m_vec.m128_f32[v];
    	}
        ...
        INLINE float Length() {
            return DirectX::XMVector4Length(m_vec).m128_f32[0];
        }
